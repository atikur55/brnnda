...
// **************************************  AJAX REQUESTS SECTION *****************************************
  ...
  // Display Attributes for Selected Childcategory Starts
      ...
      $(document).on('change','#childcat',function () {
        ...
        if(link != "")
        {
          $('#grandchildcat').load(link);
          $('#grandchildcat').prop('disabled',false);
        }
  ...
  // Display Attributes for Selected Childcategory Ends
    ...
    // Display Attributes for Selected Grand Childcategory Starts
    $(document).on('change','#grandchildcat',function () {

      $.get(getattrUrl + '?id=' + this.value + '&type=grandchildcategory', function(data) {
        console.log(data);
        let attrHtml = '';
        for (var i = 0; i < data.length; i++) {
          attrHtml += `
...
// Display Attributes for Selected Grand Childcategory Ends
