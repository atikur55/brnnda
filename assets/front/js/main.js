...
$mainSlider.on('changed.owl.carousel', function(event) {
    ...
    $('[data-countdown]').each(function () {
        ...
        $this.countdown(finalDate, function (event) {
            ...
            var st = 'background-color:#0c1725;margin-left:2px;padding:5px;color:#fff;border-radius:5px;  background: linear-gradient(to bottom, red 50%,yellow 20%,#0c1725 40%)';
            $this.html(event.strftime('<span style="'+st+'">%D </span> <span style="'+st+'"> %H </span>  <span style="'+st+'">%M </span> <span style="'+st+'">%S </span>'));
            }
        });
    });
...
// trending item  slider
    var $catSlider = $('.slider-for-category');
