...
//**************************** CUSTOM JS SECTION ****************************************
    ...
    $("#registerform").on('submit', function (e) {
      ...
      $.ajax({
        ...
        success: function (data) {
          ...
          if(data=="Please wait for OTP Message"){
            window.location = mainurl + '/user/otp';
         }

         if (data == "You are already registered. Please verify your mobile number") {
           // window.location = mainurl + '/user/dashboard';
             window.location = mainurl + '/user/rmobile';
         } else {
    ...
    $("#forgotform").on('submit', function (e) {
      ...
      $.ajax({
        ...
        //   if(data="Please wait for OTP Message"){
        //     window.location = mainurl + '/user/forgototp';
        //  }

         if (data['status'] == 1) {
           console.log(data);
           // window.location = mainurl + '/user/dashboard';
             window.location = mainurl + '/user/forgototp/'+data['phone'];
         } 
          if ((data.errors)) {
            $this.find('.alert-success').hide();
            $this.find('.alert-info').hide();
