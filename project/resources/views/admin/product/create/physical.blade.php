				...
				<i class="icofont-upload-alt"></i> {{ __('Upload Image Here') }}
						                    ...
						                    <div class="showbox">
												...
												<div class="row">
													...
													<div class="col-lg-7">
														<input name="cashback" step="0.1" type="number" class="input-field" placeholder="{{ __('e.g 2000') }}" min="0">
													</div>
												</div>
												...
												<div class="row">
													...
													<div class="col-lg-7">
														<input type="text" class="input-field" placeholder="{{ __('Enter Commission') }}" name="commission"  value="">
													</div>
												</div>
												...
												<div class="row">
													...
													<div class="col-lg-7">
														<input type="text" class="input-field" placeholder="{{ __('Enter Product Tax') }}" name="product_tax"  value="">
												...
												<div class="row">
													...
													<div class="col-lg-7">
														...
														<input type="checkbox" class="" name="product_tax_status"  value="1"> 	<span class="sub-heading">Check if vat is excluded</span>
													</div>
											...
											<div class="showbox">
											 ...
											 <div class="row">
						                        ...
						                        <div class="row">
						                          <div class="col-lg-4">
						                            <div class="left-area">
						                                <h4 class="heading">{{ __('Tags (Seperate with comma)') }} *</h4>
						                            </div>
						                          </div>
						                          <div class="col-lg-7">
