										 ...
										 {{-- <div class="row">
						                    ...
						                    <div class="{{ !empty($data->whole_sell_qty) ? "":"showbox" }}">
												...
												<div class="row">
													<div class="col-lg-4">
														<div class="left-area">
																<h4 class="heading">{{ __('Cash back') }}*</h4>
																<p class="sub-heading">{{ __('(Optional)') }}</p>
														</div>
													</div>
													<div class="col-lg-7">
														<input name="cashback" step="0.1" type="number" class="input-field" placeholder="{{ __('e.g 2000') }}" 
														value="{{round($data->cashback * $sign->value , 2)}}"
														min="0">
													</div>
												</div>
												...
												<div class="row">
													<div class="col-lg-4">
														<div class="left-area">
																<h4 class="heading" style="color:orange" >{{ __('Product Commission') }} </h4>
																<p class="sub-heading">{{ __('(amount)') }}</p>
														</div>
													</div>
													<div class="col-lg-7">
														<input type="text" class="input-field" placeholder="{{ __('Enter Commission') }}" name="commission"  value="{{ $data->commission }}">
													</div>
												</div>
												...
												<div class="row">
													<div class="col-lg-4">
														<div class="left-area">
																<h4 class="heading" style="color:orange" >{{ __('Product tax') }} </h4>
																<p class="sub-heading">{{ __('(amount)') }}</p>
														</div>
													</div>
													<div class="col-lg-7">
														<input type="text" class="input-field" placeholder="{{ __('Enter Product Tax') }}" name="product_tax"  value="{{ $data->product_tax }}">
													</div>
												</div>
												...
												<div class="row">
													<div class="col-lg-4">
														<div class="left-area">
																<h4 class="heading" style="color:orange" >{{ __('Vat exluded') }} </h4>
															
														</div>
													</div>
													<div class="col-lg-7">
												
														<input type="checkbox" class="" name="product_tax_status"  value="1" 	@if( $data->product_tax_status==1) checked @else @endif  > 	<span class="sub-heading">Check if vat is excluded</span>
													</div>
