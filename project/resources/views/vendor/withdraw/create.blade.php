                         ...
                         <form id="geniusform" class="form-horizontal" action="{{route('vendor-wt-store')}}" method="POST" enctype="multipart/form-data">
                                ...
                                <div id="bank" style="display: none;">
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-sm-12">
                                            <input name="address" value="{{ old('address') }}" placeholder="Routing Number" class="form-control" type="text">
                                        </div>
                                    </div>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-sm-12">
                                        <textarea class="form-control" name="reference" rows="6" placeholder="Bank name and Branch" required>{{ old('reference') }}</textarea>
                                    </div>
                                </div>
                                ...
                                <strong>
                                    ...
                                    {{-- {{ $langg->lang494 }} ${{ $gs->withdraw_fee }} {{ $langg->lang495 }} {{ $gs->withdraw_charge }}% {{ $langg->lang496 }} --}}
