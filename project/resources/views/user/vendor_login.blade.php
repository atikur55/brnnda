          ...
          <div class="tab-pane fade show active" id="nav-log" role="tabpanel" aria-labelledby="nav-log-tab">
            <div class="login-area">
              ...
              <div class="login-form signin-form">
                ...
                <form class="" action="{{ route('vendor.login.submit') }}" method="POST">
                  {{ csrf_field() }}
          ...
          <div class="tab-pane fade" id="nav-reg" role="tabpanel" aria-labelledby="nav-reg-tab">
            <div class="login-area signup-area">
              ...
              <div class="login-form signup-form">
                ...
                @include('includes.admin.form-login')
                <form class="mregisterform" action="{{route('vendor-register-submit')}}" method="POST">
                  {{ csrf_field() }}

                  <div class="form-input">
                    <!--<input type="text" class="User Name" name="name" placeholder="{{ $langg->lang182 }}" required="">-->
                    <input type="text" class="User Name" name="name" placeholder="Shop Or Brand Name" required="">
                    <i class="icofont-user-alt-5"></i>
                  </div>
