...
@endif
								...
								@if(!Auth::guard('web')->check())
									...
									@else
										...
										<li class="profilearea my-dropdown">
											<a href="{{ route('user-profile') }}" id="profile-icon" class="profile carticon" style="font-size:18px">
												<span class="text">
													{{-- <i style="color: white" class="far fa-user" ></i> --}}
													<img src="{{asset('assets/images/user (2).svg')}}" >	
													{{-- {{ $langg->lang11 }}
									...
									<li class="my-dropdown"  data-toggle="tooltip" data-placement="top" title="{{ $langg->lang3 }}">
										<a href="javascript:;" class="cart carticon">
											<div class="icon ">
												...
												<span class="cart-quantity header-icon-val" id="cart-count">
	...
	<!--<div class="container res-nav-height" style="height:40px">-->
    <div class="container res-nav-height">

		<div class="row align-items-center mainmenu-area-innner">
			<div class="col-lg-3 col-md-6 categorimenu-wrapper remove-padding nav-cat-res">
				...
				<div class="col-lg-9 col-md-6 mainmenu-wrapper remove-padding nav-for-res">
					<nav hidden>
						...
						<ul class="menu">
							...
							<li><a href="{{ route('front.offerproducts') }}">OFFER OF THE DAY</a></li>  
							<li>
								@if($gs->reg_vendor == 1)
				...
				<div class="col-md-6 col-lg-3">
					<div class="footer-info-area">
						...
						<div class="text" style="color:white">
							...
							<?php echo htmlspecialchars_decode($gs->footer); ?>
							...
							@if($gs->reg_vendor == 1)
								...
								@if(Auth::check())
									@if(Auth::guard('web')->user()->is_vendor == 2)
										...
										<i class="fas fa-angle-double-right"></i>	Merchant Panel
										</a>
									@else
										<a onclick="alert('you have to logout first')" href="{{ route('vendor.login') }}" style="color:white">
