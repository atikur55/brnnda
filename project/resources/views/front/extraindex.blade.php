...
@if($ps->partners == 1)
	<!-- Partners Area Start -->
	<div class="container-fluid d-none d-md-block" style="background: #ccc;height:100px;padding-top:35px">
		...
		<div class="container">
			...
			<div class="row" >
				<div class="col-lg-2" >
					<div class="">
						<h2 class="" style="font-size:16px;border-right:1px solid #143250">
						OUR PARTNERS
						</h2>
					</div>
				</div>
...
{{-- Info Area Start --}}
<section class="info-area d-none d-md-block">
		<div class="container">
