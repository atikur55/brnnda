						...
						<div class="intro-carousel">
							@foreach($sliders as $data)
								<div class="intro-content {{$data->position}}" style="background-image: url({{asset('assets/images/sliders/'.$data->photo)}})">
									<div class="container">
										<div class="row">
										    <a href="{{url('slider/category/product')}}/{{$data->id}}">
											<div class="col-lg-12">
		...
		<section  class="trending">
			<div class="container">
				...
				<div class="row">
					...
					<div class="col-lg-12 remove-padding">
						    <style>
						        .slider-for-category.owl-carousel .owl-stage{
								    margin: 0!important;
								}
						    </style>
						<div class="slider-for-category" style="padding: 0 13px !important;">
							@foreach($categories as $data)
							<div class="catSliderItem">
							    <div class="row">
							        <div class="col-4">
							            <img src="{{ asset('assets/images/categories/'.$data->photo) }}" alt="">
							        </div>
							        <div class="col-8">
							            <a href="{{url('category')}}/{{$data->slug}}">{{ $data->name }}</a>
							        </div>
							    </div>
							</div>
