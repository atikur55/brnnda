...
class CheckoutController extends Controller
{
    ...
    public function checkout()
    {
        ...
        if(Auth::guard('web')->check())
        {
                ...
                $total = (float)Session::get('coupon_total');  
    ...
    public function cashondelivery(Request $request)
    {
        ...
        $order['cart'] = utf8_encode(urlencode(serialize($cart))); 
        ...
        if($request->used_wallet!=''){
                    if((float)$uw->wallet>$request->used_wallet){
        ...
        //     'wallet' =>(string)($w+(float)$request->total_cashback) /* EIT code */
        // ]);
    ...
    public function eitsslcommerzPayment(Request $request)
    {
