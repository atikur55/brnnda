...
// -------------------------------- HOME PAGE SECTION ----------------------------------------
	...
	public function index(Request $request)
	{
        ...
        $new_products =  Product::where('latest','=',1)->where('status','=',1)->orderBy('id','desc')->take(8)->get();

        
        // $vendor =  DB::table('faqs')->orderBy('id','desc')->get();
        // return view('front.faq',compact('faqs'));
    
        $u = new User();
        $vendor =  $u->where('is_vendor',2)->where('featured_vendor','featured')->orderBy('id','desc')->get();
     

	    return view('front.index',compact('ps','sliders','top_small_banners','feature_products','vendor','new_products'));
	}
...
public function vendorList()
{
    ...
    $u = new User();
    $vendor =  $u->where('is_vendor',2)->orderBy('id','desc')->get();
    // dump($vendor);die();
    return view('front.vendorproducts',compact('vendor'));

}


public function singleVendorProduct()
{
    $this->code_image();
...
// -------------------------------- Vendor List SECTION ENDS----------------------------------------


// -------------------------------- All Products SECTION ----------------------------------------
public function allProducts(Request $request, $slug=null, $slug1=null, $slug2=null)
{
  $cat = null;
  $subcat = null;
  $childcat = null;
...
// -------------------------------- All Products SECTION ----------------------------------------
public function offerProducts(Request $request, $slug=null, $slug1=null, $slug2=null)
{
  $cat = null;
  $subcat = null;
  $childcat = null;
  ...
  $prods = Product::when($cat, function ($query, $cat) {
                              ...
                              $prods = $prods->where('status', 1)->where('is_discount',1)->get();
  $prods = (new Collection(Product::filterProducts($prods)))->paginate(12);
