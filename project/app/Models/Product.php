...
class Product extends Model
{
    ...
    public function showPrice() {
        ...
        // $com = round((float)$gs->fixed_commission + (float)($this->price/100) * (float)$gs->percentage_commission);

        // $price =$com;
        // $price = $this->price - $gs->fixed_commission - ($this->price * $gs->percentage_commission)/100 ;
        // }
