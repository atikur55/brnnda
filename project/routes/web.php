...
Route::get('/otptest', 'Test\OtpTest@otpTest');
// Google Login
Route::get('auth/google','LoginWithGoogleController@redirectToGoogle');
Route::get('auth/google/callback','LoginWithGoogleController@handleGoogleCallback');
Route::prefix('admin')->group(function() {
  ...
  Route::get('/vendor/featured/{id}', 'Admin\VendorController@featured')->name('admin-vendor-featured');
...
// Verification Section Ends
  ...
  /* Grand child attr*/
  Route::get('/attribute/{grandchildcatid}/attrCreateForGrandchildcategory', 'Admin\AttributeController@attrCreateForGrandchildcategory')->name('admin-attr-createForGrandchildcategory');
  ...
  // grandchildcategory SECTION ------------

Route::get('/grandchildcategory/datatables', 'Admin\GrandChildCategoryController@datatables')->name('admin-grandchildcat-datatables'); //JSON REQUEST

Route::get('/grandchildcategory', 'Admin\GrandChildCategoryController@index')->name('admin-grandchildcat-index');
Route::get('/grandchildcategory/create', 'Admin\GrandChildCategoryController@create')->name('admin-grandchildcat-create');
Route::post('/grandchildcategory/create', 'Admin\GrandChildCategoryController@store')->name('admin-grandchildcat-store');
Route::get('/grandchildcategory/edit/{id}', 'Admin\GrandChildCategoryController@edit')->name('admin-grandchildcat-edit');
Route::post('/grandchildcategory/edit/{id}', 'Admin\GrandChildCategoryController@update')->name('admin-grandchildcat-update');
Route::get('/grandchildcategory/delete/{id}', 'Admin\GrandChildCategoryController@destroy')->name('admin-grandchildcat-delete');
Route::get('/grandchildcategory/status/{id1}/{id2}', 'Admin\GrandChildCategoryController@status')->name('admin-grandchildcat-status');
Route::get('/load/grandchildcategories/{id}/', 'Admin\GrandChildCategoryController@load')->name('admin-grandchildcat-load'); //JSON REQUEST

// grandchildcategory SECTION ENDS------------
...
Route::prefix('user')->group(function() {
  ...
  // Vendor Login
  Route::get('/vendor/login', 'User\LoginController@VendorshowLoginForm')->name('vendor.login');
  Route::post('/vendor/login', 'User\LoginController@Vendorlogin')->name('vendor.login.submit');
  // Vendor Login End

  // Vendor Register
  Route::post('/vendor/register', 'User\RegisterController@Vendorregister')->name('vendor-register-submit');
  // Route::get('register/verify/{token}', 'User\RegisterController@token')->name('user-register-token');
  // Vendor Register End
  ...
  // User OTP
  Route::get('/otp', 'User\RegisterController@showOtpForm')->name('user-otp');
  Route::post('/otp-submit', 'User\RegisterController@otpSubmit')->name('user-otp-submit');

  //User register otp
  Route::get('/rmobile', 'User\RegisterController@showRMobileForm')->name('user-rmobile');
  Route::get('/rotp', 'User\RegisterController@showROtpForm')->name('user-rotp');
  Route::post('/rotp/submit', 'User\RegisterController@RotpSubmit')->name('user-rotp-submit');


  // User Forgot

  
  Route::get('/forgototp/{phone}', 'User\ForgotController@showForgotOtpForm')->name('user-forgototp');
  Route::post('/forgototp-submit', 'User\ForgotController@ForgotOtpSubmit')->name('user-forgototp-submit');


  Route::get('/forgot', 'User\ForgotController@showforgotform')->name('user-forgot');
  Route::post('/forgot', 'User\ForgotController@forgot')->name('user-forgot-submit');
  Route::get('/forgot-password-change', 'User\ForgotController@forgotPasswordChange')->name('forgot-password-change');
  Route::post('/forgot-reset-submit', 'User\ForgotController@forgotPasswordChangeSubmit')->name('forgot-reset-submit');
  // User Forgot Ends
...
Route::get('/under-maintenance', 'Front\FrontendController@maintenance')->name('front-maintenance');
  ...
  Route::group(['middleware'=>'maintenance'],function()
  {
      ...
      Route::post('/success', 'eitaamarpayController@success')->name('payment.success');
      Route::post('/cancel', 'eitaamarpayController@cancel')->name('payment.cancel');

      Route::post('/failed', 'eitaamarpayController@fail')->name('payment.failed');
...
// ************************************ FRONT SECTION **********************************************
  ...
  // FAQ SECTION ENDS
    ...
    // Vendor List SECTION
  Route::get('/vendor_list','Front\FrontendController@vendorList')->name('front.vendorlist');
 
  Route::get('/single_vendor_product/{id}','Front\FrontendController@singleVendorProduct')->name('front.single_vendor_product');
  // Vendor List ENDS

    // All Products SECTION
  Route::get('/all_products','Front\FrontendController@allProducts')->name('front.allproducts');
  // All Products SECTION ENDS
    // All Products SECTION
    Route::get('/offer_products','Front\FrontendController@offerProducts')->name('front.offerproducts');
    // All Products SECTION ENDS
  ...
  // TAG SECTION ENDS
//new
// Route::get('/{id}', 'ShowSliderController@products_brands')->name('frontend.slider.index');
Route::get('slider/category/product/{id}', 'ShowSliderController@products_brands')->name('frontend.slider.index');
//new end
  ...
  /*eit code*/
  //use wallet
  Route::get('/walletcheck','Front\CartController@walletcheck');
  Route::get('/wallet_un_check','Front\CartController@wallet_un_check');
  /* eit code end*/
  ...
  /* Eit sslcommerz */
  Route::post('/pay', 'eitaamarpayController@index')->name('eitsslcommerzpayment.submit');
  /* Eit sslcommerz end */
