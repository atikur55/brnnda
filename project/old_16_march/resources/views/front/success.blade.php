                                                        ...
                                                        <div class="billing-add-area">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-6">
                                                                    ...
                                                                    {{-- <p>Cashback:৳ {{$order->total_cashback}} </p> --}}
                                                                    ...
                                                                    <p>
                                                                        ...
                                                                        {{ $langg->lang294 }} Online payment
                                                                        @else
                                                                        
                                                                        {{ $langg->lang294 }} Cashon Delivery
                                                                        @endif 
                                                                    </p>
                                                                    ...
                                                                    @if($order->method != "Cash On Delivery")
                                                                        ...
                                                                        @endif --}}
                                                                        @if($order->ssl_transaction_id != '')
                                                                        Transaction ID: {{$order->ssl_transaction_id}}
                                                                        @endif
                            ...
                            <table  class="table">
                                ...
                                @endforeach
                                    <tr>
                                        ...
                                        <td>Grand Total</td>
                                        <td>{{-- {{ $langg->lang293 }}  --}}
                                             {{$order->pay_amount - $order->shipping_cost}}+{{$order->shipping_cost}}
