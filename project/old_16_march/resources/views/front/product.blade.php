...
<section class="product-details-page">
  <div class="container">
            ...
            <div class="col-lg-7">
              <div class="right-area">
                <div class="product-info">
                  ...
                  <div class="deal-counter" style="margin-bottom:20px;">
                    <div data-countdown="{{ $productt->discount_date }}"></div>
                  ...
                  {{-- <p class="badge badge-pill badge-warning">Cashback - {{ $productt->cashback }} ৳</p>

                  @if($productt->product_payment_method == 1)
													<p class="badge badge-pill badge-success">Online payment only</p>
												@elseif($productt->product_payment_method == 2)
                  ...
                  <li class="review-count">
                      ...
                      <div class="dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="dropdownMenu2">
                          <div class="social-links social-sharing a2a_kit a2a_kit_size_32" style="width:200px">
            ...
            <div class="product-price">
              {{-- <p class="title"> --}}
                ...
                {{-- Price:
                    ...
                    @if($productt->product_tax_status==1)
                      {{-- <small style="border:1px solid #ccc; padding:2px;border-radius:10px;font-size:12px;padding:0px 6px;">Vat </small> --}}
                      <small style="border:1px solid #ccc; padding:2px;border-radius:10px;font-size:12px;padding:0px 6px;">+ @isset($productt->product_tax){{ $productt->product_tax }} @else 0 @endisset% VAT</small>
                   @endif
                    </p><br>
                    <p class="price" style=""> <small><del>{{ $productt->showPreviousPrice() }}</del></small></p>
                    <span style="color:green;font-size:14px" id="dc">
                      @if($productt->showPreviousPrice()!='')
                      @php 
                          $f = (((float)$productt->showPreviousPrice()-(float)$productt->showPrice())/(float)$productt->showPreviousPrice())*100;
                      @endphp
                      ...
                      <!--<a href="{{ $productt->youtube }}" class="video-play-btn mfp-iframe" style="display:none">-->
                      ...
                      <li class="d-block count {{ $productt->type == 'Physical' ? '' : 'd-none' }}">
                        <div class="qty">
                          <ul>
                              <li>
                                  <span class="qttxt">
                                      <p style="margin-right:26px">Qnty :</p>
                                  </span>
                              </li>
                            <li>
                              <span class="qtminus">
                            ...
                            <li>
                              <span class="qttotal" style="margin-left:-1px">1</span>
                            </li>
                            <li>
                              <span class="qtplus" style="margin-left:-1px">
    ...
    @if( $productt->user_id  != 0)
        <a href="{{ route('front.vendor',str_replace(' ', '-', $productt->user->shop_name)) }}" class="view-stor">Visit Store </a>
    @endif
