    ...
    <div class="row row-cards-one">
        ...
        <div class="col-md-12 col-lg-6 col-xl-4">
            <div class="mycard bg7">
                <div class="left">
                    <h5 class="title">{{ __('Total Sell amount') }}</h5>
                    <span class="number">{{$total_sell}}</span>
                    {{-- <a href="{{ route('admin-blog-index') }}" class="link">{{ __('View All') }}</a> --}}
                </div>
                <div class="right d-flex align-self-center">
                    <div class="icon">
        ...
        <div class="col-md-12 col-lg-6 col-xl-4">
            <div class="mycard bg7">
                <div class="left">
                    <h5 class="title">{{ __('Total Completed Sell amount') }}</h5>
                    <span class="number">{{$total_completed_sell}}</span>
                    {{-- <a href="{{ route('admin-blog-index') }}" class="link">{{ __('View All') }}</a> --}}
                </div>
                <div class="right d-flex align-self-center">
                    <div class="icon">
        ...
        <div class="col-md-12 col-lg-6 col-xl-4">
            <div class="mycard bg7">
                <div class="left">
                    <h5 class="title">{{ __('Total withdraw') }}</h5>
        ...
        <div class="col-md-12 col-lg-6 col-xl-4">
            <div class="mycard bg7">
                <div class="left">
                    <h5 class="title">{{ __('Commission with shipping cost!') }}</h5>
                    <span class="number">{{$commission_with_shipping}}</span>
                    {{-- <a href="{{ route('admin-blog-index') }}" class="link">{{ __('View All') }}</a> --}}
                </div>
                <div class="right d-flex align-self-center">
                    <div class="icon">
        ...
        <div class="col-md-12 col-lg-6 col-xl-4">
            <div class="mycard bg7">
                <div class="left">
                    <h5 class="title">{{ __('Total Completed Shipping cost') }}</h5>
                    <span class="number">{{$total_completed_shipping}}</span>
                    {{-- <a href="{{ route('admin-blog-index') }}" class="link">{{ __('View All') }}</a> --}}
                </div>
                <div class="right d-flex align-self-center">
                    <div class="icon">
        ...
        <div class="col-md-12 col-lg-6 col-xl-4">
            <div class="mycard bg7">
                <div class="left">
                    <h5 class="title">{{ __('Total Commission!') }}</h5>
                    <span class="number">{{$commission}}</span>
                    {{-- <a href="{{ route('admin-blog-index') }}" class="link">{{ __('View All') }}</a> --}}
                </div>
                <div class="right d-flex align-self-center">
                    <div class="icon">
        ...
        <div class="col-md-12 col-lg-6 col-xl-4">
            <div class="mycard bg8">
                <div class="left">
                    <h5 class="title">{{ __('Canceled orders!') }}</h5>
