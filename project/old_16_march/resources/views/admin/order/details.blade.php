                                        ...
                                        <div class="table-responsive-sm">
                                            <table class="table">
                                                ...
                                                <tr>
                                                    ...
                                                    <th width="10%">:</th>
                                                        <td width="45%"><span class=''>{{$order->ssl_transaction_id}}</span></td>
                                                </tr>
                                                @endif
                                                ...
                                                <tr>
                                                    ...
                                                    @if($order->status == 'pending')
                                                     ...
                                                     <td width="45%"><span class='badge badge-danger'>Pending</span></td>
                                                    
                                                    {{--  {!! $order->payment_status == 'Pending' ? "<span class='badge badge-danger'>Pending</span>":"<span class='badge badge-success'>Completed</span>" !!}  --}}

                                                    @elseif($order->status == 'processing')
                                                        <td width="45%"><span class='badge badge-warning'>Processing</span></td>

                                           
                                                      @elseif($order->status == 'on delivery')
                                                     <td width="45%"><span class='badge badge-info'>On delivery</span></td>
                                          

                                                    @elseif($order->status == 'completed')
                                                     <td width="45%"><span class='badge badge-success'>Completed</span></td>
                                                    @endif
                                                    </tr>
