...
class UserController extends Controller
{
    ...
    public function chkPhoneVerified($phone_verified){
    ...
    public function index()
    {
        ...
        $cpv = $this->chkPhoneVerified($user->phone_verified);
    ...
    public function vendorrequestsub(Request $request)
    {
        ...
        $settings = Generalsetting::findOrFail(1);
                    ...
                    return redirect()->route('user-dashboard')->with('success','Vendor subscription request accepted. Wait for activation');
